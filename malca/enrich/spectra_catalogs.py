...
DEFAULT_SPECTRA_CATALOG_SPECS: dict[str, SpectraCatalogSpec] = {
    ...
    "apogee_dr16": SpectraCatalogSpec(vizier_id="J/A+A/682/A54/catalog"),
    "manga_dr17": SpectraCatalogSpec(vizier_id="J/ApJS/262/36/catalog"),
    "lamost_dr7": SpectraCatalogSpec(vizier_id="V/156/dr7lrs"),
    "galah_dr3": SpectraCatalogSpec(vizier_id="J/A+A/648/A85/allstar"),
    ...
    "cks": SpectraCatalogSpec(vizier_id="J/AJ/155/89/table5"),
    ...
    "gaia_eso": SpectraCatalogSpec(vizier_id="J/A+A/666/A120/allparam"),
    "vvds": SpectraCatalogSpec(vizier_id="III/250/vvds"),
    "deep2": SpectraCatalogSpec(vizier_id="III/294/deep2"),
    "zcosmos": SpectraCatalogSpec(vizier_id="J/A+A/559/A2/table2"),
    "vandels": SpectraCatalogSpec(vizier_id="J/A+A/678/A25/table5"),
    "vipers": SpectraCatalogSpec(vizier_id="J/A+A/609/A84/pdr2"),
    "wigglez": SpectraCatalogSpec(vizier_id="J/MNRAS/401/1429/wigglez"),
    "primus": SpectraCatalogSpec(vizier_id="J/ApJ/767/118/primus"),
    "ozdes": SpectraCatalogSpec(vizier_id="J/MNRAS/496/19/table1"),
    "gama": SpectraCatalogSpec(vizier_id="VII/291/gama"),
    ...
    "s5": SpectraCatalogSpec(vizier_id="J/MNRAS/531/4108/table1"),
    "efeds_agn": SpectraCatalogSpec(vizier_id="J/A+A/661/A3/table1"),
    "2dflens": SpectraCatalogSpec(vizier_id="J/MNRAS/462/4240/2dflens"),
    "class": SpectraCatalogSpec(vizier_id="VIII/66/class"),
}
