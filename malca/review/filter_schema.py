...
SIDEBAR_GROUPS = [
    ...
    ("Candidate Context", [
        ...
        ("text", "gaia_id"),
        ("text", "gaia_dr2_id"),
        ("text", "gaia_id_release"),
        ("text", "gaia_id_mapping_status"),
        ("num", "dr2_dr3_angular_distance_mas"),
        ("num", "dr2_dr3_magnitude_difference"),
        ("num", "ra"),
        ("num", "dec"),
        ("num", "phot_g_mean_mag"),
    ...
    ("Photometry", [
        ...
        ("num", "w3_w4"),
        ("num", "sed_alpha"),
        ("select", "sed_alpha_class"),
        ("num", "sed_alpha_n_points"),
        ("num", "sed_alpha_lambda_min_micron"),
        ("num", "sed_alpha_lambda_max_micron"),
        ("text", "sed_alpha_bands_json"),
        ("select", "sed_alpha_status"),
        ("num", "iphas_ha_mag"),
        ("num", "iphas_r_ha"),
        ("num", "iphas_ha_excess"),
        ("num", "vphas_ha_mag"),
