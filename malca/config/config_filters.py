...
PRE_PERIODICITY_N_BOOTSTRAP = 128
PRE_PERIODICITY_SIGNIFICANCE = 1e-3
PRE_PERIODICITY_PDM_SNR_THRESHOLD = 5.0
PRE_PERIODICITY_CE_SNR_THRESHOLD = 5.0
...
PRE_PERIODICITY_STRONG_SINGLE_SCATTER_RATIO_MAX = 0.7
PRE_PERIODICITY_LAG_PHASE_MAX = 0.25
PRE_PERIODICITY_STRONG_SINGLE_SIG = 1e-4

# Periodic phase-folded dip branch
PERIODIC_EVENTS_PHASE_BINS = 64
PERIODIC_EVENTS_PROFILE_SMOOTH_WINDOW = 5
PERIODIC_EVENTS_MIN_POINTS = 50
