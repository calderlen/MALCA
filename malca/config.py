...
MALCA_CACHE_ROOT = Path(os.environ.get("MALCA_CACHE_ROOT", str(DEFAULT_OUTPUT_DIR / "cache")))
...
GP_PAD_DAYS = 5.0
GP_LATE_ONSET_BUFFER_DAYS = 100.0
GP_MIN_ANCHOR_OVERLAP_DAYS = 30.0
GP_MIN_QUIET_BASELINE_DAYS = 250.0
GP_CONSENSUS_START_RESID_SIGMA = 3.0
...
INJECTION_TOTAL_TRIALS = 1_000_000
...
SPECTRA_TAP_CHUNK_SIZE = 500
SPECTRA_TAP_TIMEOUT = 900.0
...
NEOWISE_MIN_SNR = 3.0
# qual_frame is 0/5/10 in neowiser_p1bs_psd (higher is better).
NEOWISE_QUAL_FRAME_MIN = 5.0
