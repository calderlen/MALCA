...
def main():
    ...
    parser.add_argument("--characterize-starhorse-cache", type=Path, default=None, help="Optional StarHorse TAP cache parquet path (default: output/cache/catalogs/starhorse_tap_cache.parquet)")
