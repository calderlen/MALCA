...
# Deprecated no-op retained for CLI/config compatibility. The pregate now uses
# deterministic routing without bootstrap rescans.
PRE_PERIODICITY_N_BOOTSTRAP = 0
PRE_PERIODICITY_SIGNIFICANCE = 1e-3
PRE_PERIODICITY_PDM_METHOD = "plavchan"
PRE_PERIODICITY_PDM_SNR_THRESHOLD = 10.0
PRE_PERIODICITY_CE_SNR_THRESHOLD = 10.0
PRE_PERIODICITY_PDM_MIN_THETA = 0.6
PRE_PERIODICITY_CE_MIN_ENTROPY = 0.6
PRE_PERIODICITY_MIN_POINTS = 50
PRE_PERIODICITY_AGREEMENT_REL_TOL = 0.1
PRE_PERIODICITY_SCATTER_RATIO_MAX = 0.8
PRE_PERIODICITY_STRONG_SINGLE_SCATTER_RATIO_MAX = 0.8
PRE_PERIODICITY_LAG_PHASE_MAX = 0.25
# Deprecated no-op retained for CLI/config compatibility.
PRE_PERIODICITY_STRONG_SINGLE_SIG = 1e-4
