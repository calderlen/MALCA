...
REVIEW_METADATA_GROUPS: list[tuple[str, list[tuple[str, str]]]] = [
    ("Triage Summary", [
        ...
        ("YSO class", "yso_class"),
        ("ML dipper probability", "prob_dipper_like"),
    ...
    ("Event Scoring", [
        ("ML hierarchy gate", "predicted_hierarchy_gate"),
        ("ML primary morphology", "predicted_primary_morphology"),
        ("ML hierarchical class", "predicted_hierarchical_class"),
        ("ML P(reject)", "prob_hierarchical_artifact_or_nonvariable"),
        ("ML P(usable)", "prob_usable_astrophysical_variable"),
        ("ML P(dipper / dimming)", "prob_dipper_dimming"),
        ("ML P(EB / geometric)", "prob_eb_geometric_periodic"),
        ("ML P(long-timescale)", "prob_long_timescale_variable"),
        ("ML P(brightening)", "prob_brightening_transient"),
        ("ML P(other structured)", "prob_other_structured_variable"),
        ("ML P(quasi-periodic)", "prob_quasi_periodic_hierarchical"),
        ("ML P(microlensing)", "prob_microlensing_hierarchical"),
        ("ML P(LPV)", "prob_long_period_variable_hierarchical"),
        ("ML P(LTV)", "prob_long_term_variable_hierarchical"),
        ("ML quasi-periodic class", "predicted_quasi_periodic"),
        ("ML microlensing class", "predicted_microlensing_like"),
        ("ML long-timescale subtype", "predicted_long_timescale_subtype"),
        ("ML P(dipper | usable)", "prob_primary_dipper_dimming_given_usable"),
        ("ML P(EB | usable)", "prob_primary_eb_geometric_periodic_given_usable"),
        ("ML P(long | usable)", "prob_primary_long_timescale_variable_given_usable"),
        ("ML P(bright | usable)", "prob_primary_brightening_transient_given_usable"),
        ("ML P(other | usable)", "prob_primary_other_structured_variable_given_usable"),
        ("ML P(QP | usable)", "prob_quasi_periodic_given_usable"),
        ("ML P(microlensing | bright)", "prob_microlensing_given_brightening"),
        ("ML P(LPV | long)", "prob_long_period_variable_given_long_timescale"),
        ("ML P(LTV | long)", "prob_long_term_variable_given_long_timescale"),
    ...
    ("Dip Detection", [
        ...
        ("Dip best tau rise", "dip_best_tau_rise"),
        ("Dip best tau fall", "dip_best_tau_fall"),
    ...
    ("Dip Recurrence", [
        ("Observed dip recurrence", "dipper_recurrence_class"),
        ("Recurrence evidence", "dipper_recurrence_evidence"),
        ("ML P(recurrent | dipper)", "prob_recurrent_given_dipper"),
        ("ML P(single | dipper)", "prob_single_given_dipper"),
        ("ML P(recurrent dipper), binary", "prob_recurrent_dipper_binary"),
        ("ML P(recurrent dipper), hierarchy", "prob_recurrent_dipper_hierarchical"),
        ("ML P(single dipper), hierarchy", "prob_single_dipper_hierarchical"),
        ("ML recurrence class", "predicted_dipper_recurrence"),
    ...
    ("Jump Detection", [
        ...
        ("Jump best tau rise", "jump_best_tau_rise"),
        ("Jump best tau fall", "jump_best_tau_fall"),
    ...
    ("Periodicity", [
        ...
        ("Periodicity period (d)", "periodicity_period"),
        ("Periodicity method", "periodicity_method"),
        ("Periodicity base period (d)", "periodicity_base_period"),
        ("Periodicity harmonic factor", "periodicity_harmonic_factor"),
        ("Periodicity fold objective", "periodicity_harmonic_objective"),
        ("Periodicity scatter ratio", "periodicity_scatter_ratio"),
        ("Periodicity alias flag", "periodicity_alias_flag"),
        ("Periodicity alias matches", "periodicity_alias_matches"),
        ("Periodicity bootstrap sig", "periodicity_bootstrap_sig"),
        ("Periodicity is significant", "periodicity_is_significant"),
        ("PDM period (d)", "pdm_period"),
        ("PDM corrected period (d)", "pdm_corrected_period"),
        ("PDM harmonic factor", "pdm_harmonic_factor"),
        ("PDM fold objective", "pdm_harmonic_objective"),
        ("PDM scatter ratio", "pdm_harmonic_scatter_ratio"),
        ("PDM alias flag", "pdm_alias_flag"),
        ("PDM alias matches", "pdm_alias_matches"),
        ("PDM theta", "pdm_theta"),
        ("PDM SNR", "pdm_snr"),
        ("CE period (d)", "ce_period"),
        ("CE corrected period (d)", "ce_corrected_period"),
        ("CE harmonic factor", "ce_harmonic_factor"),
        ("CE fold objective", "ce_harmonic_objective"),
        ("CE scatter ratio", "ce_harmonic_scatter_ratio"),
        ("CE alias flag", "ce_alias_flag"),
        ("CE alias matches", "ce_alias_matches"),
        ("CE entropy", "ce_entropy"),
        ("CE SNR", "ce_snr"),
        ("Legacy LSP period alias (d)", "lsp_period"),
        ("Legacy LSP bootstrap sig alias", "lsp_bootstrap_sig"),
        ("Legacy LSP power", "lsp_power"),
        ("Legacy LSP is alias", "lsp_is_alias"),
        ("Legacy LSP is significant alias", "lsp_is_significant"),
    ]),
    ("Phase Folding", [
    ...
    ("Gaia Binary Evidence", [
        ("EB evidence level", "gaia_eb_evidence_level"),
        ("EB evidence score", "gaia_eb_evidence_score"),
        ("Binary evidence level", "gaia_binary_evidence_level"),
        ("Binary evidence score", "gaia_binary_evidence_score"),
        ("Evidence families", "gaia_binary_evidence_families"),
        ("Evidence rule version", "gaia_binary_evidence_version"),
        ("Evidence score meaning", "gaia_binary_evidence_score_kind"),
        ("Evidence family count", "gaia_binary_n_evidence_families"),
        ("Evidence summary", "gaia_binary_evidence_summary"),
        ("Reference period (d)", "gaia_binary_reference_period"),
        ("Reference period source", "gaia_binary_reference_period_source"),
        ("Independent periods", "gaia_binary_period_n_independent"),
        ("Independent period agreement", "gaia_binary_period_agreement"),
        ("Agreement sources", "gaia_binary_period_agreement_sources"),
        ("Period conflict", "gaia_binary_period_conflict"),
        ("Conflict sources", "gaia_binary_period_conflict_sources"),
        ("NSS solutions", "gaia_nss_solution_count"),
        ("NSS solution types", "gaia_nss_solution_types"),
        ("NSS representative type", "gaia_nss_solution_type"),
        ("NSS period (d)", "gaia_nss_period"),
        ("NSS period error (d)", "gaia_nss_period_error"),
        ("NSS SB1", "gaia_nss_has_sb1"),
        ("NSS SB2", "gaia_nss_has_sb2"),
        ("NSS spectroscopic", "gaia_nss_has_spectroscopic"),
        ("NSS astrometric", "gaia_nss_has_astrometric"),
        ("NSS eclipsing", "gaia_nss_has_eclipsing"),
        ("NSS eclipsing + spectroscopic", "gaia_nss_has_eclipsing_spectro"),
        ("NSS EB duplicates Gaia photometric period", "gaia_nss_photometric_duplicate_of_eb"),
        ("NSS K1 (km/s)", "gaia_nss_semi_amplitude_primary"),
        ("NSS K2 (km/s)", "gaia_nss_semi_amplitude_secondary"),
        ("NSS mass ratio", "gaia_nss_mass_ratio"),
        ("NSS inclination (deg)", "gaia_nss_inclination"),
        ("Gaia RV variable", "gaia_rv_variable_flag"),
        ("Gaia RV large amplitude", "gaia_rv_large_amplitude_flag"),
        ("Astrometric anomaly", "gaia_astrometric_anomaly_flag"),
        ("Blend/contamination warning", "gaia_blend_contamination_flag"),
        ("Gaia EB period error (d)", "gaia_eb_period_error"),
        ("Gaia EB reduced chi2", "gaia_eb_reduced_chi2"),
        ("Primary eclipse depth (mag)", "gaia_eb_primary_depth"),
        ("Secondary eclipse depth (mag)", "gaia_eb_secondary_depth"),
        ("Primary eclipse duration (phase)", "gaia_eb_primary_duration"),
        ("Secondary eclipse duration (phase)", "gaia_eb_secondary_duration"),
        ("Eclipse depth ratio", "gaia_eb_depth_ratio"),
        ("Eclipse phase separation", "gaia_eb_eclipse_phase_separation"),
        ("Two fitted eclipses", "gaia_eb_two_eclipses"),
    ]),
    ("Stellar Parameters", [
        # -- Gaia DR3 --
        ...
        ("Astrometric excess noise", "astrometric_excess_noise"),
        ("Astrometric excess noise sig", "astrometric_excess_noise_sig"),
        ("Astrometric good AL obs", "astrometric_n_good_obs_al"),
        ("Astrometric sigma5d max", "astrometric_sigma5d_max"),
        ("Visibility periods", "visibility_periods_used"),
        ("IPD multi-peak fraction", "ipd_frac_multi_peak"),
        ("IPD odd-window fraction", "ipd_frac_odd_win"),
        ("IPD harmonic GOF amplitude", "ipd_gof_harmonic_amplitude"),
        ("Duplicated source", "duplicated_source"),
        ("Gaia NSS product bitmask", "non_single_star"),
        ("Gaia RV transits", "rv_nb_transits"),
        ("Gaia RV chi-square p", "rv_chisq_pvalue"),
        ("Gaia RV renormalised GOF", "rv_renormalised_gof"),
        ("Gaia RV baseline (d)", "rv_time_duration"),
        ("Fidelity", "fidelity"),
        ...
        ("PM RA (mas/yr)", "pmra"),
        ("PM Dec (mas/yr)", "pmdec"),
        ("Corr(parallax, PM RA)", "parallax_pmra_corr"),
        ("Corr(parallax, PM Dec)", "parallax_pmdec_corr"),
        ("Corr(PM RA, PM Dec)", "pmra_pmdec_corr"),
    ...
    ("External Follow-up", [
        ...
        ("ATLAS preprocess", "atlas_preprocess_version"),
        ("ATLAS raw rows", "atlas_n_raw"),
        ("ATLAS good rows", "atlas_n_good"),
        ("ATLAS rejected rows", "atlas_n_rejected"),
    ...
    ("Environment", [
        ...
        ("BANYAN young-association prob", "banyan_ya_prob"),
        ("BANYAN best assoc", "banyan_best_assoc"),
        ("BANYAN best assoc prob", "banyan_best_assoc_prob"),
        ("BANYAN status", "banyan_status"),
        ("BANYAN input mode", "banyan_input_mode"),
        ("Mapped-SFR BANYAN name", "banyan_sfr_name"),
        ("Mapped-SFR BANYAN prob", "banyan_sfr_prob"),
        ("Mapped-SFR best component", "banyan_sfr_best_assoc"),
        ("Mapped-SFR best component prob", "banyan_sfr_best_assoc_prob"),
        ("Mapped-SFR agrees with cloud", "banyan_sfr_agrees"),
        ("SFR name", "sfr_name"),
        ...
        ("UCC match status", "ucc_match_status"),
        ("UCC release", "ucc_catalog_release"),
        ("UCC cluster", "ucc_cluster"),
        ("UCC membership prob", "ucc_pmem"),
        ("UCC listed", "ucc_listed_member"),
        ("UCC P>=0.5 member", "ucc_p50_member"),
        ("UCC reliable member", "ucc_good_member"),
        ("UCC trust index", "ucc_uti"),
        ("UCC C3", "ucc_c3"),
        ("UCC duplicate prob", "ucc_pdup"),
        ("UCC likely non-cluster", "ucc_bad_oc"),
        ("UCC age (Myr)", "ucc_age_myr"),
        ("Nearest UCC cluster", "ucc_nearest_cluster"),
        ("Nearest UCC sep (arcmin)", "ucc_nearest_sep_arcmin"),
        ("Nearest UCC sep/r50", "ucc_nearest_sep_r50"),
        ("H&R match status", "hr24_match_status"),
        ("H&R cluster", "hr24_cluster"),
        ("H&R membership prob", "hr24_pmem"),
        ("H&R cluster type", "hr24_cluster_type"),
        ("H&R bound member", "hr24_bound_member"),
        ("H&R high-quality member", "hr24_high_quality_member"),
        ("H&R CST", "hr24_cst"),
        ("H&R median CMD class", "hr24_cmd_class_median"),
        ("Cloud-environment matches", "sfr_environment_matches"),
        ("Cloud-environment consistent", "sfr_environment_consistent"),
        ("Catalog member", "sfr_catalog_member"),
        ("Catalog match status", "sfr_catalog_match_status"),
        ("Membership catalog", "sfr_catalog_name"),
        ("Membership catalog reference", "sfr_catalog_reference"),
        ("Catalog membership prob", "sfr_catalog_membership_prob"),
        ("Kinematic SFR", "sfr_kinematic_name"),
        ("Kinematic method", "sfr_kinematic_method"),
        ("Kinematically consistent", "sfr_kinematic_consistent"),
        ("Kinematic Mahalanobis D2", "sfr_kinematic_mahalanobis_sq"),
        ("Kinematic p-value", "sfr_kinematic_p_value"),
        ("Kinematic member count", "sfr_kinematic_n_members"),
        ("SFR membership class", "sfr_membership_class"),
        ("SFR membership name", "sfr_membership_name"),
        ("SFR membership evidence", "sfr_membership_evidence"),
        ("SFR membership status", "sfr_membership_status"),
        ("SFR membership threshold", "sfr_membership_threshold"),
        ("SFR membership version", "sfr_membership_version"),
    ]),
    ("YSO / Classification", [
