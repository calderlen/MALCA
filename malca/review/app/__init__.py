...
_PARTS = ['imports.py', 'background.py', 'bootstrap.py', 'styles.py', 'runtime.py', 'constants.py', 'renderers.py', 'paths.py', 'state.py', 'components.py', 'layout.py', 'callbacks/clientside.py', 'callbacks/eda.py', 'callbacks/sidebar.py', 'filters.py', 'callbacks/queue.py', 'callbacks/review_save.py', 'callbacks/plot.py', 'callbacks/sed.py', 'callbacks/spectrum.py', 'callbacks/fitting.py', 'callbacks/diagnostics.py', 'callbacks/export_plot.py', 'callbacks/review_form.py', 'callbacks/taxonomy.py', 'callbacks/session.py', 'callbacks/import_fetch.py', 'callbacks/pipeline.py', 'callbacks/export_merge.py', 'cli.py']
