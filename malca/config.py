...
# Nuclear AGN/TDE/CLAGN injection benchmark
NUCLEAR_INJECTION_OUTPUT_DIR = DEFAULT_OUTPUT_DIR / "runs" / "nuclear" / "injection"
NUCLEAR_INJECTION_CLASSES = "agn,tde,clagn,control"
NUCLEAR_INJECTION_AMP_MIN = 0.05
NUCLEAR_INJECTION_AMP_MAX = 1.0
NUCLEAR_INJECTION_AMP_STEPS = 8
NUCLEAR_INJECTION_TIMESCALE_MIN_DAYS = 30.0
NUCLEAR_INJECTION_TIMESCALE_MAX_DAYS = 3000.0
NUCLEAR_INJECTION_TIMESCALE_STEPS = 8
NUCLEAR_INJECTION_REPEATS_PER_GRID = 32
NUCLEAR_INJECTION_CONTROL_SAMPLE_SIZE = 1024
NUCLEAR_INJECTION_MIN_SCORE = 0.5
NUCLEAR_INJECTION_MIN_MARGIN = 0.05
NUCLEAR_INJECTION_CHECKPOINT_INTERVAL = 100
NUCLEAR_INJECTION_CHUNK_SIZE = 100
...
CHANDRA_CSC_CATALOG_ID = "IX/70/csc21mas"
